...
typedef enum {
  ...
  LIGHT_SENS_CONTINUOUS_MEASURE_STATE, ///< Device is measuring continuously, generates an interrupt on threshold exceed
...
typedef struct {
  ...
  uint16_t highLimit; ///< high limit for lux (in raw)
} LIGHT_SENS_Actor_t;
