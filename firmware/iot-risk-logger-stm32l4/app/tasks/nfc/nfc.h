...
/** Maximum payload size for log chunks (mailbox - header - status byte) */
#define NFC_MAX_LOG_CHUNK_SIZE                      (ST25DV_MAX_MAILBOX_LENGTH - NFC_MAILBOX_PROTOCOL_HEADER_SIZE - 1)
/** @} */
